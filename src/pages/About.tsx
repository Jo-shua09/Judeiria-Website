...
import judeAbout from "@/assets/hero.jpg";
...
const About = () => {
  ...
  return (
    <>
      <Helmet>
        <title>About Jude Iria | Business Consultant & Career Coach</title>
        <meta
          name="description"
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-6 lg:gap-20 items-center">
              <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}>
                ...
                <p className=" text-muted-foreground leading-relaxed mb-4">
                  At my core, I help people make sense of growth. Over the years, I've worked with founders, professionals, and personal brands who
                  were talented, driven, and ambitious, but stuck.
                </p>
