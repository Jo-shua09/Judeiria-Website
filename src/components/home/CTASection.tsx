    ...
    <section ref={ref} className="section-padding bg-primary text-primary-foreground">
      <div className="container-narrow mx-auto text-center">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold mb-6">If you're unsure of your next step, that's okay.</h2>

          <p className="text-xl md:text-2xl text-accent font-heading font-semibold mb-6">Clarity comes before growth.</p>
